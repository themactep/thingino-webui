...
<dt class="cp2cb">rtsp://root:root@<%= $network_address %>/stream=0</dt>
<dd>RTSP main stream (video0).</dd>
<dt class="cp2cb">rtsp://root:root@<%= $network_address %>/stream=1</dt>
...
<h3>Audio</h3>
<dl>
<dt class="cp2cb">http://root:root@<%= $network_address %>/audio.opus</dt>
<dd>Opus audio stream.</dd>
<dt class="cp2cb">http://root:root@<%= $network_address %>/audio.m4a</dt>
...
<dt class="cp2cb">http://root:root@<%= $network_address %>/image.heif</dt>
